...
// Source: github.com/pentops/o5-aws-tool/libo5/j5/registry/registry/v1/registry

import (
	context "context"
	errors "errors"
	client "github.com/pentops/o5-aws-tool/libo5/j5/client/v1/client"
	url "net/url"
	strings "strings"
)
...
func (s DownloadService) DownloadJDef(ctx context.Context, req *DownloadJDefRequest) (*DownloadJDefResponse, error) {
	pathParts := make([]string, 7)
	pathParts[0] = ""
	pathParts[1] = "registry"
	pathParts[2] = "v1"
...
// DownloadJDefResponse
type DownloadJDefResponse struct {
}
...
func (s DownloadJDefRequest) QueryParameters() (url.Values, error) {
	values := url.Values{}
	return values, nil
}
